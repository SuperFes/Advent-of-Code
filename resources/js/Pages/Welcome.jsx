...
const Days = [
    ...
    {label: '03', content: React.lazy(() => import("@/Days/03/Problem.jsx")), enabled: false, stars: 2},
    {label: '04', content: React.lazy(() => import("@/Days/04/Problem.jsx")), enabled: false, stars: 2},
    {label: '05', content: React.lazy(() => import("@/Days/05/Problem.jsx")), enabled: false, stars: 5},
